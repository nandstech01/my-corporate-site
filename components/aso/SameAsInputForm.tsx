...
import type { SameAsSettings, OrganizationSameAs, AuthorSameAs } from '@/lib/aso/types/tenant-settings';
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <UrlInput
            ...
            icon={<Github className="w-4 h-4" style={{ color: isDark ? '#ffffff' : '#24292e' }} />}
