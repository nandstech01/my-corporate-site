...
import type { AuthorSettings } from '@/lib/aso/types/tenant-settings';
    ...
    <div className="space-y-5">
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid ${isDark ? 'rgba(34,211,238,0.2)' : 'rgba(34,211,238,0.1)'}`,
        }}
      >
        <p className="text-sm" style={{ color: isDark ? '#67e8f9' : '#0891b2' }}>
