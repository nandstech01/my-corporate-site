...
export default function AIHeroSection() {
	...
	return (
		<section className="relative sm:min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black overflow-hidden">
			...
			<div className="relative z-20 flex flex-col items-center justify-start lg:justify-start sm:min-h-screen px-4 lg:px-8 pt-4 pb-6 sm:pb-12 lg:pt-8 lg:pb-12">
