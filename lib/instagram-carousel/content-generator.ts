...
{
  "hookLine1": "カテゴリ（必ず8文字。例: 最新のAI仕事術、知らないと損する、今すぐ使えるAI）",
  "hookLine2": "メインキーワード（最もインパクトのある単語。短い方が良い。例: Claude Code、バイブコーディング）",
  "hookLine3": "コンテンツ種類（例: 活用術5選、完全ガイド、徹底比較、始め方3選）",
...
ルール:
- 全て日本語で書くこと
- hookLine1は必ず8文字（多くても少なくてもダメ。8文字ぴったり）
