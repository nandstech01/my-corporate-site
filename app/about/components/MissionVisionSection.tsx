...
export default function MissionVisionSection() {
  return (
    <>
      ...
      <div id="mission-vision" style={{ display: 'none' }} aria-hidden="true" />
              ...
              <div className="text-center max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-12">
                  <div className="bg-black/30 border border-cyan-400/30 rounded-lg p-6 hover:border-cyan-400/50 transition-colors">
                    <p className="text-cyan-200 text-sm font-medium leading-relaxed">最新技術を活用した実践的なスキル開発支援</p>
                  </div>
                  <div className="bg-black/30 border border-cyan-400/30 rounded-lg p-6 hover:border-cyan-400/50 transition-colors">
                    <p className="text-cyan-200 text-sm font-medium leading-relaxed">個々のニーズに寄り添った丁寧なキャリア支援</p>
                  </div>
                  <div className="bg-black/30 border border-cyan-400/30 rounded-lg p-6 hover:border-cyan-400/50 transition-colors">
                    <p className="text-cyan-200 text-sm font-medium leading-relaxed">安心・確実な転職・退職プロセスのサポート</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="text-center max-w-4xl mx-auto">
                ...
                <div className="space-y-8">
                  <div className="bg-black/30 border border-cyan-400/30 rounded-xl p-8 text-left hover:border-cyan-400/50 transition-colors">
                    ...
                    <p className="text-cyan-100 leading-relaxed">働く人々のキャリアトランスフォーメーションと成長支援を実現</p>
                  </div>
                  <div className="bg-black/30 border border-cyan-400/30 rounded-xl p-8 text-left hover:border-cyan-400/50 transition-colors">
                    <h4 className="text-xl font-bold text-green-400 mb-3">企業変革</h4>
                    <p className="text-cyan-100 leading-relaxed">企業のデジタルトランスフォーメーションとAI活用推進を支援</p>
                  </div>
                  <div className="bg-black/30 border border-cyan-400/30 rounded-xl p-8 text-left hover:border-cyan-400/50 transition-colors">
                    <h4 className="text-xl font-bold text-purple-400 mb-3">社会貢献</h4>
                    <p className="text-cyan-100 leading-relaxed">日本のAIリテラシー向上を通じた、グローバル競争力の強化</p>
                  </div>
                </div>
              </div>
            </div>
