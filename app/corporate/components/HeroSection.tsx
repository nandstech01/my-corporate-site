...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-blue-900">
      ...
      >
        ...
        <button
          className="relative bg-blue-600 text-white py-3 px-8 rounded-full text-lg font-semibold hover:bg-blue-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
        >
          無料相談はこちら
        </button>
      </animated.div>
