...
import AdminSidebar from '@/components/clavi/AdminSidebar';
  ...
  useEffect(() => {
    const checkAdminAuth = async () => {
      try {
        ...
        const response = await fetch('/api/clavi/admin/stats?period=7d', {
          credentials: 'include',
      ...
      >
        ...
        >
          ...
          <div className="space-y-3">
            <button
              onClick={() => router.push('/clavi/dashboard')}
