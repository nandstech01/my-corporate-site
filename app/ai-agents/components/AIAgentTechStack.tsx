  ...
  return (
    <section id="tech-stack" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* セキュリティ・コンプライアンス */}
        <div className="mt-16 bg-red-50 border border-red-200 p-8 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">ISO27001準拠</h4>
              <p className="text-sm text-gray-600">
                情報セキュリティマネジメントシステム国際標準準拠
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">SOC2認証</h4>
              <p className="text-sm text-gray-600">
                セキュリティ・可用性・機密性・プライバシー保護認証
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">GDPR対応</h4>
              <p className="text-sm text-gray-600">
                EU一般データ保護規則完全準拠・プライバシーバイデザイン
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">ゼロトラスト</h4>
              <p className="text-sm text-gray-600">
                ゼロトラスト・アーキテクチャによる包括的セキュリティ
              </p>
            </div>
          </div>
        </div>
