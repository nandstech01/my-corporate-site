import type { QuestionStep, QuestionnaireAnswers } from './types'
...
function getFeaturesBySystemType(answers: QuestionnaireAnswers): string[] {
...
export const questionnaireSteps: QuestionStep[] = [
  {
    ...
    placeholder:
      '例: 社内の勤怠管理をデジタル化したい、ECサイトを作りたい、など',
    maxLength: 500,
    required: true,
  },
  {
  ...
  },
  {
    ...
    type: 'button-grid',
    field: 'employeeCount',
    options: ['1-10', '11-50', '51-100', '101-500', '500以上'],
    required: true,
  },
  {
    id: 4,
    title: 'システムの導入先を教えてください',
    subtitle: 'どちらに導入しますか？',
    type: 'button-grid',
    field: 'systemDestination',
    options: ['自社導入', 'クライアント先'],
    required: true,
  },
  {
    id: 5,
  ...
  {
    id: 9,
    title: '対応するデバイスを選んでください',
    subtitle: '複数選択可能です',
    type: 'checkbox',
    field: 'devices',
    options: ['PC(Windows)', 'PC(Mac)', 'iOS', 'Android', 'タブレット'],
    required: true,
  },
  {
    id: 10,
...
export const TOTAL_STEPS = questionnaireSteps.length
