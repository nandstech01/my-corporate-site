              ...
              {'image' in service && service.image ? (
                <div className={`relative overflow-hidden ${'imageContain' in service && service.imageContain ? 'aspect-[5/3] bg-white' : 'aspect-[2/1] bg-slate-100'}`}>
                  <Image
                    ...
                    alt={service.title}
                    fill
                    className={`${'imageContain' in service && service.imageContain ? 'object-contain' : 'object-cover'} ${'imagePosition' in service && service.imagePosition ? service.imagePosition : 'object-top'} ${'imageOffset' in service && service.imageOffset ? service.imageOffset : ''}`}
