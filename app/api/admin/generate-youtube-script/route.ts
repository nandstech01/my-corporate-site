...
11. 🆕【重要】SNS投稿用文章も生成（YouTube投稿と同時に全SNS展開）:
   - ❶ X（Twitter）用: 280文字以内・厳守、簡潔でインパクト重視
   - ❷ Threads用: 500文字以内・厳守、親しみやすく技術的
   - ❸ LinkedIn用: タイトル（100文字）+ 説明（1300文字）、プロフェッショナル
   - ❹ TikTok用: 150文字推奨、若者向けでエモーショナル
   - 全SNSで共通タグを使用（YouTubeタグと同じ）
...

{
  ...
  "x_post": "X（Twitter）用投稿文（280文字以内・厳守、簡潔でインパクト重視、ハッシュタグ2-3個含む、改行効果的に使う）",
  "threads_post": "Threads用投稿文（500文字以内・厳守、親しみやすくストーリー性、技術的詳細2-3個、絵文字適度に使う）",
  "linkedin_title": "LinkedIn用タイトル（100文字以内・厳守、プロフェッショナルで具体的、技術的価値を明確に）",
  "linkedin_description": "LinkedIn用説明文（1300文字以内・厳守、プロフェッショナルなトーン、技術的詳細深く、ビジネス価値明確、構造化された内容）",
  "tiktok_caption": "TikTok用キャプション（150文字推奨・200文字以内、若者向けトレンド重視、短くインパクト、エモーショナル、ハッシュタグ3-5個）"
}
