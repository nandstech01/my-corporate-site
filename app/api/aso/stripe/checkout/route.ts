...
export async function POST(request: Request) {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `${baseUrl}/aso/subscription/success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${baseUrl}/aso/pricing`,
      metadata: {
        tenant_id: tenant_id,
        tenant_name: tenant.name,
      },
