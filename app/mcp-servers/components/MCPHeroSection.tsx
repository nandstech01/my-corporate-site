    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20 md:pt-40 md:pb-32">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
          Model Context Protocol（MCP）による高度なAIシステム連携。
          <br className="hidden md:block" />
          最新プロトコル技術で拡張性の高いAI基盤を構築
        </p>

        {/* 特徴ボックス */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 text-center">
            <div className="text-3xl font-bold text-blue-400 mb-2">最新版</div>
            <div className="text-gray-300 text-sm">Protocol Latest対応</div>
          </div>
          <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 text-center">
            <div className="text-3xl font-bold text-cyan-400 mb-2">高性能</div>
            <div className="text-gray-300 text-sm">リアルタイム通信</div>
          </div>
          <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 text-center">
            <div className="text-3xl font-bold text-blue-400 mb-2">拡張性</div>
            <div className="text-gray-300 text-sm">柔軟な統合機能</div>
          </div>
        </div>
