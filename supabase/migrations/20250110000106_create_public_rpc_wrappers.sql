-- ============================================
-- Task 5.7: publicスキーマからclaviスキーマのRPCを呼び出すラッパー関数
-- ============================================
-- 作成日: 2025-01-10
-- 目的: Supabase JSクライアントがclaviスキーマのRPCを呼び出せるようにする
...
'clavi.get_or_create_job_user のpublicスキーマラッパー（Supabase JSクライアント用）';
...
'clavi.cleanup_old_audit_logs のpublicスキーマラッパー（Supabase JSクライアント用）';
