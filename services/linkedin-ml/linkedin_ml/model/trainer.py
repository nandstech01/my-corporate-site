...
from linkedin_ml.config import MODELS_DIR, MIN_TRAINING_SAMPLES
...
def fetch_training_data(
    ...
    response = (
        client.table("linkedin_post_analytics")
        .select("ml_features, likes, comments, reposts, impressions")
